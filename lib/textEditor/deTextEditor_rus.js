...
var deTextEditor_rus = jQuery.Class.create({  // текстовый редактор 
...
$(document).ready(function () {			
	...
	code+=' 		<b><a class="'+deTE+'btn" href="#de" id="'+deTE+'btnBold"			>Ж</a></b>';
	code+=' 		<i><a class="'+deTE+'btn" href="#de" id="'+deTE+'btnItalic"			>К</a></i>';
	code+=' 		<u><a class="'+deTE+'btn" href="#de" id="'+deTE+'btnUnderline"		>Ч</a></u>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnFontType"		>Шрифт</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnFontSize"		>Размер</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnFontColor"		>Цвет</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnBackColor"		>Фон</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnOrdList"		>Список</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnImg"			>Изображение</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnLink"			>Ссылка</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnLeft"			>Слева</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnCenter"			>По центру</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnRight"			>Справа</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnRemoveFormat"	>Очистить</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnSelectAll"		>Выделить все</a>';
	code+=' 		   <a class="'+deTE+'btn" href="#de" id="'+deTE+'btnPrint"			>Печать</a>';
	code+='		</div>';
...
$('#'+deTE+'btnFontSize').live("click", function(){						
	deWin.focus();
    userFSize = deWin.prompt("Введите размер шрифта (1-7):", "3");
...
$('#'+deTE+'btnFontType').live("click", function(){						
	deWin.focus();
    userFType = deWin.prompt("Введите имя шрифта:", "sans-serif");
...
$('#'+deTE+'btnFontColor').live("click", function(){						
	deWin.focus();
    userFColor = deWin.prompt("Введите цвет шрифта (6ти значный код) #:", "000066");
...
$('#'+deTE+'btnImg').live("click", function(){						
	deWin.focus();
    imgURL = deWin.prompt("Введите адрес:", "http://");
...
$('#'+deTE+'btnLink').live("click", function(){						
	deWin.focus();
    userURL = deWin.prompt("Введите адрес ссылки:", "http://");
    //deWin.execCommand("Unlink",false,null)
...
$('#'+deTE+'btnBackColor').live("click", function(){						
	deWin.focus();
    userBgColor = deWin.prompt("Введите цвет фона (6ти значный код) #:", "006699");
