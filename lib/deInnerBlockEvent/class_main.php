...
function head() {
	...
	echo	'<head>';
	echo		'<title>Dement.ru :: Добавление html-кода внутрь блока при определенном событии</title>';												
	...
	echo			'new deInnerBlockEvent(';							// innerHTML при определенном событии 
	echo			'"idTargetImage",';									// id на который повесится событие
	echo			'"click",';											// событие
...
function action() { 
	...
	echo		'<img id="idTargetImage" src="http://www.dement.ru/!lib/_img/strelka.jpg">';
	echo	'</div>';
}
